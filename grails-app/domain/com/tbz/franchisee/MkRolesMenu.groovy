...
class MkRolesMenu implements Serializable {
	...
	static mapping = {
		id composite: ["chRoleCode", "vcModuleCode", "vcMenuCode", "chStatFlag", "chStatUpFlag", "dtModDate", "vcAuthCode", "vcField1", "vcField2", "vcField3", "vcField4", "dtField1", "dtField2", "nuField1", "nuField2", "brCode"]
		version false
	}
