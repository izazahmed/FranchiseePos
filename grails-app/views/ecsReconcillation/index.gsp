<%-- 
-- File Name: index
-- Description: This page displays index Page of ECS Reconcillation
-- Author(s): CTE. 
-- Date: 01/02/2016 
-- MOD HISTORY
-- DATE           	USER				COMMENTS
	...
	<script type="text/javascript">
		...
		function getTaxVal(){
			...
			if(dd == ""){
			    ...
			    var parameter = {dd:dd}
				$.ajax({
				 	url: "${request.getContextPath()}/ecsReconcillation/getExactCustomerData",
					async : false,
					data : parameter,
				...
				<div class="dashboard_detail_bg">
					<div class="col-md-12">
						...
						<div id="create-ecsReconcillation" class="content scaffold-create">
							...
							<g:form name="ecsReconcillationForm" id="ecsReconcillationForm">
