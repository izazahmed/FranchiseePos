<%-- 
     -- File Name: labelTransferChecklistReport
     -- Description: it is used to get the labelTransferChecklistReport
     -- Author(s): CTE 
     -- Date: 23/05/2016 
     -- MOD HISTORY
     -- DATE           USER             COMMENTS
...
<title>Lable transfer Checklist Report</title>
...
function displayTextOnCat(){
  ...
  function validateLabelTransferChecklistReport(format,extension) {    
  	var flag = "";
  	flag = validate();
  	if(!flag){
  		return false;
  	}else{  	
  		document.getElementById('labelTransferChecklistForm').format1.value = format;
		document.getElementById('labelTransferChecklistForm').extension.value = extension;
		
        document.getElementById("labelTransferChecklistForm").action ="createLabelTransferChecklistReport";
     	document.getElementById("labelTransferChecklistForm").submit();
  	}  	  	     	
  }
  function validate(){
  		var flag = false;  		  		  		
				...
				<div class="dashboard_detail_bg">
					<div class="col-md-12">
						<div id="create-mstApprovalAuth" class="content scaffold-create">
							<h1>Lable transfer Checklist Report</h1>
							...
							<g:form name="labelTransferChecklistForm" id="labelTransferChecklistForm">
											...
											<div class="panel panel-default">
												<table class="table">
													<thead>
														...
														<tr>
															<td>From Locator</td>
															<td><g:textField name="fromLocator" class="form-control" />	
														</tr>
														<tr>															
															<td>To Locator</td>
															<td><g:textField name="toLocator" class="form-control" />										
														</tr>	
													</thead>
												</table>
											</div>
									...
									<div class="row">
										<div class="col-md-8">
											...
											<div class="pull-right rightsapce">
												<g:submitButton name="Submit" class="active_btn" value="View" onclick="return validateLabelTransferChecklistReport('view','view')"></g:submitButton>
												<g:submitButton name="Submit" class="active_btn" value="PDF" onclick="return validateLabelTransferChecklistReport('pdf','pdf')"></g:submitButton>
												<g:submitButton name="Submit" class="active_btn" value="CSV" onclick="return validateLabelTransferChecklistReport('csv','csv')"></g:submitButton>
											</div>
										</div>
									</div>
								</div>
