<%-- 
     -- File Name: gs12Report
     -- Description: it is used to get the gs12Report
     -- Author(s): CTE 
     -- Date: 23/05/2016 
     -- MOD HISTORY
     -- DATE           USER             COMMENTS
...
function displayTextOnCat(){
  ...
  function validateGs12Report(format,extension) {
  alert(format);   
  alert(extension);
  	var flag = "";
  	flag = validate();
  	if(!flag){
  		...
  		document.getElementById('gs12Form').format1.value = format;
		document.getElementById('gs12Form').extension.value = extension;
		
        document.getElementById("gs12Form").action ="createGs12Report";
     	document.getElementById("gs12Form").submit();
  	}  	  	     	
  }
  function validate(){
  		var flag = false;  		  		  		
				...
				<div class="dashboard_detail_bg">
					<div class="col-md-12">
						<div id="create-mstApprovalAuth" class="content scaffold-create">
							...
							<g:form name="gs12Form" id="gs12Form">
									...
									<div class="row">
										<div class="col-md-8">
											...
											<div class="pull-right rightsapce">
												<g:submitButton name="Submit" value="View" class="active_btn" onclick="return validateGs12Report('view','view')"></g:submitButton>
												<g:submitButton name="Submit" value="PDF" class="active_btn" onclick="return validateGs12Report('pdf','pdf')"></g:submitButton>
												<g:submitButton name="Submit" value="CSV" class="active_btn" onclick="return validateGs12Report('csv','csv')"></g:submitButton>
											</div>
										</div>
									</div>
								</div>	
