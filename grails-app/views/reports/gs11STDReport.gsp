<%-- 
     -- File Name: gs11STDReport
     -- Description: it is used to get the gs11STDReport
     -- Author(s): CTE 
     -- Date: 23/05/2016 
     -- MOD HISTORY
     -- DATE           USER             COMMENTS
...
function displayTextOnCat(){
  ...
  function validateGs11STDReport(format,extension) {    
  	var flag = "";
  	flag = validate();
  	if(!flag){
  		return false;
  	}else{  	
  		document.getElementById('gs11STDForm').format1.value = format;
		document.getElementById('gs11STDForm').extension.value = extension;
		
        document.getElementById("gs11STDForm").action ="createGs11STDReport";
     	document.getElementById("gGs11STDorm").submit();
  	}  	  	     	
  }
  function validate(){
  		var flag = false;  		  		  		
				...
				<div class="dashboard_detail_bg">
					<div class="col-md-12">
						<div id="create-mstApprovalAuth" class="content scaffold-create">
							...
							<g:form name="gs11STDForm" id="gs11STDForm">
									...
									<div class="row">
										<div class="col-md-8">
											...
											<div class="pull-right rightsapce">
													<g:submitButton name="Submit" class="active_btn" value="View" onclick="return validateGs11STDReport('view','view')"></g:submitButton>
													<g:submitButton name="Submit" class="active_btn" value="PDF" onclick="return validateGs11STDReport('pdf','pdf')"></g:submitButton>
													<g:submitButton name="Submit" class="active_btn" value="CSV" onclick="return validateGs11STDReport('csv','csv')"></g:submitButton>
												</div>
											</div>
									</div>
								</div>
