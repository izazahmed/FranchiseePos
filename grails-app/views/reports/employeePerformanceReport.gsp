<%-- 
     -- File Name: dtEmployeePerformanaceReport
     -- Description: it is used to get the dtEmployeePerformanaceReport
     -- Author(s): CTE 
     -- Date: 15/02/2016 
     -- MOD HISTORY
     -- DATE           USER             COMMENTS
...
$(".editClick td:not(.action)").click(function () {
  ...
  function validatedtEmployeePerformanaceReport(format,extension) {    
  	var flag;
  	flag = validate();
  	if(!flag){
  		return false;
  	}else{		
  		document.getElementById('dtEmployeePerformanaceReportForm').format1.value = format;
		document.getElementById('dtEmployeePerformanaceReportForm').extension.value = extension;
		
		document.getElementById("dtEmployeePerformanaceReportForm").action ="createEmployeePerformanceReport";
     	document.getElementById("dtEmployeePerformanaceReportForm").submit();
        //$("#dtEmployeePerformanaceReportForm").submit();
        //return false;
  	}  	  	     	
  }
  function validate(){
				...
				<div class="dashboard_detail_bg">
					<div class="col-md-12">
						<div id="create-empMst" class="content scaffold-create">
							...
							<g:form name="dtEmployeePerformanaceReportForm" id="dtEmployeePerformanaceReportForm">		
								<div class="content-bg pull-left">
									...
									<div class="pull-right rightsapce">
										<g:submitButton name="Submit" value="View" class="active_btn" onclick="return validatedtEmployeePerformanaceReport('view','view')"></g:submitButton>
										<g:submitButton name="Submit" value="PDF" class="active_btn" onclick="return validatedtEmployeePerformanaceReport('pdf','pdf')"></g:submitButton>
										<g:submitButton name="Submit" value="CSV" class="active_btn" onclick="return validatedtEmployeePerformanaceReport('csv','csv')"></g:submitButton>
									</div>
								</div>
							</g:form>
						</div>
