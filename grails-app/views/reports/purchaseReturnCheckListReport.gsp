<%-- 
     -- File Name: purchaseReturnCheckListReport
     -- Description: it is used to get the purchaseReturnCheckListReport
     -- Author(s): CTE 
     -- Date: 15/02/2016 
     -- MOD HISTORY
     -- DATE           USER             COMMENTS
...
$(document).ready(function(){
  ...
  function validatePurchaseReturnCheckListReport(format,extension) {    
  	document.getElementById('purchaseReturnCheckListReportForm').format1.value = format;
	document.getElementById('purchaseReturnCheckListReportForm').extension.value = extension;
	
	document.getElementById("purchaseReturnCheckListReportForm").action ="createPurchaseReturnCheckListReport";
    document.getElementById("purchaseReturnCheckListReportForm").submit();
				...
				<div class="dashboard_detail_bg">
					<div class="col-md-12">
						<div id="create-empMst" class="content scaffold-create">
							...
							<g:form name="purchaseReturnCheckListReportForm" id="purchaseReturnCheckListReportForm">		
								<div class="content-bg pull-left">
									...
									<div class="pull-right rightsapce">
										<g:submitButton name="Submit" value="View" class="active_btn" onclick="return validatePurchaseReturnCheckListReport('view','view')"></g:submitButton>
										<g:submitButton name="Submit" value="PDF" class="active_btn" onclick="return validatePurchaseReturnCheckListReport('pdf','pdf')"></g:submitButton>
										<g:submitButton name="Submit" value="CSV" class="active_btn" onclick="return validatePurchaseReturnCheckListReport('csv','csv')"></g:submitButton>
									</div>
									</div>
									</div>
								</div>
