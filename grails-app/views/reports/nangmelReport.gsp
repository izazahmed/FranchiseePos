<%-- 
     -- File Name: nangmelReport
     -- Description: it is used to get the nangmelReport
     -- Author(s): CTE 
     -- Date: 23/05/2016 
     -- MOD HISTORY
     -- DATE           USER             COMMENTS
...
function displayTextOnCat(){
  ...
  function validateNangmelReport(format,extension) {    
  	var flag = "";
  	flag = validate();
  	if(!flag){
  		return false;
  	}else{  	
  		document.getElementById('nangmelForm').format1.value = format;
		document.getElementById('nangmelForm').extension.value = extension;
		
        document.getElementById("nangmelForm").action ="createNangmelReport";
     	document.getElementById("nangmelForm").submit();
  	}  	  	     	
  }
  function validate(){
  		var flag = false;  		  		  		
    	var nangmelDate = $('#nangmelDate').val();
    	var category = $('#category').val();
         
         if(nangmelDate !== "" && nangmelDate != null && nangmelDate !== undefined){
             flag = true;
         }else{
         	 flag = false;	
				...
				<div class="dashboard_detail_bg">
					<div class="col-md-12">
						<div id="create-mstApprovalAuth" class="content scaffold-create">
							...
							<g:form name="nangmelForm" id="nangmelForm">
											...
											<div class="panel panel-default">
												<table class="table">
													<thead>
														<tr>
															<td>From Date</td>
															<td><g:textField class="form-control startDateStr" placeholder="Nagmel Date" name="nangmelDate" />	
														</tr>
														<tr>
															<td>Category</td>
															<td>
									...
									<div class="row">
										<div class="col-md-8">
											...
											<div class="pull-right rightsapce">
												<g:submitButton name="Submit" value="View" class="active_btn" onclick="return validateNangmelReport('view','view')"></g:submitButton>
												<g:submitButton name="Submit" value="PDF" class="active_btn" onclick="return validateNangmelReport('pdf','pdf')"></g:submitButton>
												<g:submitButton name="Submit" value="CSV" class="active_btn" onclick="return validateNangmelReport('csv','csv')"></g:submitButton>
											</div>
										</div>
									</div>
								</div>
