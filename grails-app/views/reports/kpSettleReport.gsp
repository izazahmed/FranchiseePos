<%-- 
     -- File Name: dtKpSettleReport
     -- Description: it is used to get the dtKpSettleReport
     -- Author(s): CTE 
     -- Date: 15/02/2016 
     -- MOD HISTORY
     -- DATE           USER             COMMENTS
...
$(".editClick td:not(.action)").click(function () {
  ...
  function validatedtKpSettleReport(format,extension) {    
  	var flag;
  	flag = validate();
  	if(!flag){
  		return false;
  	}else{		
  		document.getElementById('dtKpSettleReportForm').format1.value = format;
		document.getElementById('dtKpSettleReportForm').extension.value = extension;
		
		document.getElementById("dtKpSettleReportForm").action ="createKpSettleReport";
     	document.getElementById("dtKpSettleReportForm").submit();
        //$("#dtKpSettleReportForm").submit();
        //return false;
  	}  	  	     	
  }
  function validate(){
				...
				<div class="dashboard_detail_bg">
					<div class="col-md-12">
						<div id="create-empMst" class="content scaffold-create">
							...
							<g:form name="dtKpSettleReportForm" id="dtKpSettleReportForm">		
									...
									<div class="row">
										<div class="col-md-8">
											...
											<div class="pull-right rightsapce">
												<g:submitButton name="Submit" value="View" class="active_btn" onclick="return validatedtKpSettleReport('view','view')"></g:submitButton>
												<g:submitButton name="Submit" value="PDF" class="active_btn" onclick="return validatedtKpSettleReport('pdf','pdf')"></g:submitButton>
												<g:submitButton name="Submit" value="CSV" class="active_btn" onclick="return validatedtKpSettleReport('csv','csv')"></g:submitButton>
											</div>
										</div>
									</div>									
								</div>	
