<%-- 
     -- File Name: createModuleListReport
     -- Description: it is used to display Module List Report Data
     -- Author(s): CTE 
     -- Date: 15/02/2016 
     -- MOD HISTORY
     -- DATE           USER             COMMENTS
								...
								<div class="col-md-12">
									<div class="panel panel-default">
										<table class="table">
											<thead>
												<tr>
													<td><strong>VC_MODULE_CODE</strong></td>						
													<td><strong>VC_MODULE_OBJECT</strong></td>
												</tr>
											</thead>
											<tbody>			
												<g:each in="${moduleList}" status="i" var="moduleInst">
													<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
														<td>${moduleInst?.VC_MODULE_CODE}</td>
														<td>${moduleInst?.VC_MODULE_OBJECT}</td>																
													</tr>					
												</g:each>																									
												</tbody>
											</table>
