<%-- 
     -- File Name: ogSaleCheckListReport
     -- Description: it is used to get the ogSaleCheckListReport
     -- Author(s): CTE 
     -- Date: 20/05/2016 
     -- MOD HISTORY
     -- DATE           USER             COMMENTS
...
<title>OG sales Check List Report</title>
...
function displayTextOnCat(){
  ...
  function validateOgSaleCheckListReport(format,extension) {    
  	var flag = "";
  	flag = validate();
  	if(!flag){
  		return false;
  	}else{  	
  		document.getElementById('ogSaleCheckListForm').format1.value = format;
		document.getElementById('ogSaleCheckListForm').extension.value = extension;
		
        document.getElementById("ogSaleCheckListForm").action ="createOgSaleCheckListReport";
     	document.getElementById("ogSaleCheckListForm").submit();
  	}  	  	     	
  }
  function validate(){
  		var flag = false;  		  		  		
				...
				<div class="dashboard_detail_bg">
					<div class="col-md-12">
						<div id="create-mstApprovalAuth" class="content scaffold-create">
							<h1>OG sales Check List Report</h1>
							...
							<g:form name="ogSaleCheckListForm" id="ogSaleCheckListForm">
							<g:hiddenField name="hidCat" />
								<div class="content-bg pull-left">
												...
												<table class="table">
													<thead>
														...
														<tr>
															...
															<td>
																<div class="textbtn">
																	<g:textField size="37" name="category" class="form-control" value="ALL"/>
									...
									<div class="pull-right rightsapce">
										<g:submitButton name="Submit" value="View" class="active_btn" onclick="return validateOgSaleCheckListReport('view','view')"></g:submitButton>
										<g:submitButton name="Submit" value="PDF" class="active_btn" onclick="return validateOgSaleCheckListReport('pdf','pdf')"></g:submitButton>
										<g:submitButton name="Submit" value="CSV" class="active_btn" onclick="return validateOgSaleCheckListReport('csv','csv')"></g:submitButton>
									</div>
									</div>
									</div>
								</div>
