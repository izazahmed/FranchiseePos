											...
											<table class="table">
												...
												<tbody>
													...
													<tr>
														...
														<td>
															${FranchiseePurchaseCheckReportList.sum { it.NANG}}
														</td>
														<td>
															${FranchiseePurchaseCheckReportList.sum { it.PCS}}
														</td>
														<td>
															${FranchiseePurchaseCheckReportList.sum { it.GRT}}
														</td>
														<td>
															${FranchiseePurchaseCheckReportList.sum { it.NET}}
														</td>														
														<td></td>
														<td>
															${FranchiseePurchaseCheckReportList.sum { it.SELLING}}
														</td>
														<td colspan="4"></td>
													</tr>
												</tbody>
									...
									<div class="panel panel-default">
										...
										<div class="col-md-8 page-header">
											<table class="table">
												...
												<tbody>
													<g:each in="${FranchiseeStonePurchaseCheckReportList}" status="i"
														var="franchiseePurchaseStoneCheckInst">
														<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
															<td>
