...
<head>
	...
	<title>Increase Other Discount</title>
									...
									<div class="row cust-tab-form">
										<div class="col-md-4 col-sm-4 col-xs-4">
											<label for="concept" class="col-sm-4 control-label">
												<g:message code="xxposOtherDiscountForm.brCode.label" default="Branch Code" />
											</label>
											<div class="col-sm-8 col-md-8 col-xs-8">
												<g:textField class="form-control" name="brCode" class="form-control" />
											</div>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-4">
											<label for="concept" class="col-sm-4 control-label">
												<g:message code="xxposOtherDiscountForm.brName.label" default="Branch Name" />
											</label>
											<div class="col-sm-6 col-md-6 col-xs-6">
												<g:textField class="form-control" name="brName" class="form-control" />
											</div>
											<div class="col-sm-2 col-md-2 col-xs-2">
												<button id="custLocatId" name="custLocat" type="button" class="active_btn" data-toggle="modal" data-target="#branchModal" style="height: 4ex;">...</button>
											</div>
										</div>
										<div class="col-md-4 col-sm-4 col-xs-4">
											<label for="concept" class="col-sm-4 control-label"><g:message
													code="customerForm.state.label" default="Discount" /></label>
											<div class="col-sm-8 col-md-8 col-xs-8">
												<g:textField class="form-control" name="nuDays" class="form-control" tabindex="1" />
											</div>
										</div>
									</div>
